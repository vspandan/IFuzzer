...
TESTS_LIB_DIR = os.path.dirname(os.path.abspath(__file__))#done
TOP_SRC_DIR = os.path.dirname(os.path.dirname(TESTS_LIB_DIR))
TEST_DIR = os.path.join(os.path.dirname(TESTS_LIB_DIR), 'tests','tests')#done
LIB_DIR = os.path.join(TESTS_LIB_DIR, 'lib') + os.path.sep#done
JS_CACHE_DIR = os.path.join(TESTS_LIB_DIR, '.js-cache')#done
JS_TESTS_DIR = posixpath.join(os.path.dirname(TESTS_LIB_DIR), 'tests2')#done
